...
from .views import (
    ...
    WorkerBroadcastInboxView,
    WorkerBroadcastActionView,
...
urlpatterns = [
    ...
    path("worker/inbox/", WorkerBroadcastInboxView.as_view(), name="worker_broadcast_inbox"),
    path(
        "worker/inbox/<uuid:broadcast_id>/action/",
        WorkerBroadcastActionView.as_view(),
        name="worker_broadcast_action",
    ),
    path(
